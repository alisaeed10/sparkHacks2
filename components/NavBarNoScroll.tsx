...
const SearchButton = styled.button`
  ...
  cursor: pointer;
  &:hover {
    background-color: #faddc8; // Use your desired hover color
  }
`;
...
const SearchBarContainer = styled.div`
  ...
  width: 100%;
  padding: 10px;
  border: 4px solid #faddc8; // Use your desired border color
  background-image: url('../public/images.png'); // Use your desired color
`;
...
const NavBarNoScroll = ({ onSearch }: { onSearch: (searchTerm: string) => void }) => {
    ...
    return (
        ...
        <NavigationLinks>
            ...
            <Link href="/HomeWorkout" passHref><NavItem>Home Workouts</NavItem></Link>
