...
const SearchButton = styled.button`
  ...
  background-color: #faddc8; // Use your desired background color
...
const NavBarContainer = styled.div`
  background-color: #fb9e72; // Replace with the color you used
  display: flex;
...
const NavItem = styled.li`
  ...
  cursor: pointer;
  &:hover {
    border-bottom: 2px solid #000000; // Adjust hover style as needed
  }
`;

const NavBarNoScroll = ({ onSearch }: { onSearch: (searchTerm: string) => void }) => {
    ...
    return (
        ...
        <NavigationLinks>
            <Link href="/Home" passHref><NavItem>Home</NavItem></Link>
            <Link href="/Motivation" passHref><NavItem>Motivation</NavItem></Link>
            <Link href="/AtHomeWorkOut" passHref><NavItem>At Home Workouts</NavItem></Link>
            <Link href="/Technique" passHref><NavItem>Technique</NavItem></Link>
        </NavigationLinks>
        </NavBarContainer>
    );
    };
